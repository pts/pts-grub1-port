...
FFLAGS='-fno-pic -fno-stack-protector -fno-builtin -fno-strict-aliasing -fno-unwind-tables -fno-asynchronous-unwind-tables -fomit-frame-pointer'  #  -fdata-sections -ffunction-sections !! ??
