...
WFLAGS='-W -Wall -Wmissing-prototypes -Wunused -Wshadow -Wpointer-arith -Wundef -Wformat-security -Wno-pointer-sign -Wno-shadow -Wno-sign-compare -Wno-missing-field-initializers'
