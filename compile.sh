...
WFLAGS='-W -Wall -Werror-implicit-function-declaration -Wmissing-prototypes -Wunused -Wshadow -Wpointer-arith -Wundef -Wformat-security -Wno-pointer-sign -Wno-shadow -Wno-sign-compare'
